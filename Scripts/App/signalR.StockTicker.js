define(['jquery', 'text!Views/StockTicker.html', 'signalr.hubs'], function($, htmlString) {
    ...
    function StockTickerViewModel(route) {
        var self = this;
    ...
    return { viewModel: StockTickerViewModel, template: htmlString };
